# Melhorias de Maturidade — n-gate
...
#### [MODIFY] [ProxyMetrics.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/observabitliy/ProxyMetrics.java)
- `package dev.nishisan.ngate.observabitliy;` → `package dev.nishisan.ngate.observability;`

#### [MODIFY] [SpanWrapper.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/observabitliy/wrappers/SpanWrapper.java)
- `package dev.nishisan.ngate.observabitliy.wrappers;` → `package dev.nishisan.ngate.observability.wrappers;`

#### [MODIFY] [TracerWrapper.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/observabitliy/wrappers/TracerWrapper.java)
- `package dev.nishisan.ngate.observabitliy.wrappers;` → `package dev.nishisan.ngate.observability.wrappers;`

#### [MODIFY] [TracerService.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/observabitliy/service/TracerService.java)
- `package dev.nishisan.ngate.observabitliy.service;` → `package dev.nishisan.ngate.observability.service;`

**Arquivos consumidores (7 — ajuste de imports):**

- [HttpProxyManager.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/http/HttpProxyManager.java) — 3 imports
- [EndpointWrapper.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/http/EndpointWrapper.java) — 4 imports
- [CustomContextWrapper.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/http/CustomContextWrapper.java) — 1 import
- [HttpResponseAdapter.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/http/HttpResponseAdapter.java) — 2 imports
- [EndpointManager.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/manager/EndpointManager.java) — 2 imports
- [NGateHealthIndicator.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/health/NGateHealthIndicator.java) — 1 import
- [JWTTokenDecoder.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/auth/jwt/JWTTokenDecoder.java) — 1 import
- [CustomClosureDecoder.java](file:///home/g0004218/Projects/n-gate/src/main/java/dev/nishisan/ngate/auth/jwt/CustomClosureDecoder.java) — 1 import
...
#### [DELETE] [.gitlab-ci.yml](file:///home/g0004218/Projects/n-gate/.gitlab-ci.yml)
...
#### [MODIFY] [pom.xml](file:///home/g0004218/Projects/n-gate/pom.xml)
...
#### [MODIFY] [release.yml](file:///home/g0004218/Projects/n-gate/.github/workflows/release.yml)
...
#### [NEW] [ConfigurationManagerTest.java](file:///home/g0004218/Projects/n-gate/src/test/java/dev/nishisan/ngate/manager/ConfigurationManagerTest.java)

Testes propostos:
1. **T1: Carga de YAML válido** — cria um `adapter.yaml` temporário válido em `/tmp`, configura via env `NGATE_CONFIG`, e verifica que `loadConfiguration()` retorna a config corretamente parseada
...
3. **T3: Prioridade de `NGATE_CONFIG`** — quando env var aponta para um YAML e outro existe em `config/adapter.yaml`, o env var prevalece
...
#### [NEW] [RulesBundleManagerTest.java](file:///home/g0004218/Projects/n-gate/src/test/java/dev/nishisan/ngate/rules/RulesBundleManagerTest.java)
