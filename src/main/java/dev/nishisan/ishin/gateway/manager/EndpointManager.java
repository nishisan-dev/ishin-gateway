...
import dev.nishisan.ishin.gateway.http.EndpointWrapper;
...
import dev.nishisan.ishin.gateway.upstream.UpstreamHealthChecker;
...
public class EndpointManager {
    ...
    private void shutdown() {
        logger.info("Ishin Gateway graceful shutdown initiated...");
        healthChecker.stop();
