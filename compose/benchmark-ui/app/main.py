...
async def run_benchmark_stream(request: Request, mode: str = "requests", requests: int = 5000,
    ...
    async def event_generator():
        ...
        env["JAVALIN_PROXY_URL"] = os.environ.get("JAVALIN_PROXY_URL", "http://ishin-gateway:9091/")

        # Cluster endpoints (propagados do docker-compose.cluster.yml)
        for var in ["CLUSTER_NODE1_URL", "CLUSTER_NODE2_URL", "CLUSTER_NODE3_URL", "CLUSTER_LB_URL", "TUNNEL_URL"]:
