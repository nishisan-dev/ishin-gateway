...
![Arquitetura Javalin 7](https://uml.nishisan.dev/proxy?src=https://raw.githubusercontent.com/nishisan-dev/ishin-gateway/main/docs/diagrams/javalin7_architecture.puml)
...
Benchmarks executados via Apache Bench contra Nginx (baseline) e ishin-gateway (proxy), nos níveis de concorrência 1, 10, 50, 100 e 500.
